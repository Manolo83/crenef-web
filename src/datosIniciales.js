...
const CONTENIDO = {
  ...
  legal_aviso_privacidad:
    'CRENEF — Clínica de Rehabilitación Neumofisio, con domicilio en Av. División del Norte 3651, Local 7, Col. San Pablo Tepetlapa, Coyoacán, C.P. 04620, Ciudad de México, es responsable del tratamiento de tus datos personales. Responsable de datos personales: Ángel Carrillo Linares.\n\nQué datos recabamos. Nombre, teléfono, correo electrónico y el motivo de consulta que nos compartes al solicitar una cita. En la clínica, y solo cuando el tratamiento lo requiere, se recaban además datos de salud, que son datos personales sensibles.\n\nPara qué los usamos. Para agendar y confirmar tus citas, darte seguimiento clínico, integrar tu expediente y responder tus dudas. No vendemos ni compartimos tus datos con terceros ajenos a estos fines.\n\nCon quién compartimos tus datos de contacto. CRENEF forma parte del grupo de marcas acompañadas por Levent (junto con Endulcora, Instituto Justo, Silman y futuros proyectos del grupo). Solo tu nombre, teléfono y correo pueden compartirse entre estas marcas para campañas de mercadotecnia, publicidad (como Meta Ads y Google Ads) y análisis interno de mercado. Tus datos de salud, tu expediente clínico y el motivo de tu consulta son datos sensibles y nunca se comparten con las demás marcas del grupo ni con nadie ajeno a tu atención: se quedan exclusivamente dentro de CRENEF.\n\nTus derechos ARCO. Puedes acceder, rectificar, cancelar u oponerte al uso de tus datos —incluido oponerte específicamente a que tus datos de contacto se compartan con las demás marcas del grupo—, así como revocar tu consentimiento, escribiendo a nuestro WhatsApp o al correo de contacto. El aviso de privacidad integral está disponible en recepción.',
  legal_aviso_medico:
